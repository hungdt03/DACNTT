...
namespace SocialNetwork.Infrastructure.Mailkit
{
    public class MailkitService : IMailkitService
    {
        ...
        public async Task SendOtpAccountVerificationAsync(string to, string otp, string fullName)
        {
            ...
            string body = LoadTemplateAccountVerification(templatePath, fullName, otp);
        ...
        public static string LoadTemplateAccountVerification(string templatePath, string fullName, string otp)
        {
