...
export type UserPostTabQueryFilter = {
    search: string;
    fromDate?: string;
    toDate?: string;
...
type UserPostTabsProps = {
    userId: string;
}

const UserPostTabs: FC<UserPostTabsProps> = ({
    userId
}) => {
    const [filter, setFilter] = useState<UserPostTabQueryFilter>({
        sortOrder: "desc",
        contentType: 'ALL',
        search: '',
    });
