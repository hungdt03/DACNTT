...
const Header: FC = () => {
    return <div className="sticky z-50 top-0 shadow w-full bg-white h-[70px] flex items-center">
        <div className="w-full flex items-center justify-between gap-x-2 md:gap-x-0 py-6 px-4 lg:px-0 max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl mx-auto">
