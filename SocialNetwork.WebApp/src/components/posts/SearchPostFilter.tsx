...
export type SearchPostFilterParams = {
    fromDate?: string;
    toDate?: string;
...
type SearchPostFilterProps = {
    onChange: (filter: SearchPostFilterParams) => void;
};

const SearchPostFilter: FC<SearchPostFilterProps> = ({ onChange }) => {
