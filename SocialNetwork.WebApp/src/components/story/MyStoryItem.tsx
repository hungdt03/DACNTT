...
type MyStoryItemProps = {
    story: MyStoryUserResource;
    onClick: () => void
}

const MyStoryItem: FC<MyStoryItemProps> = ({
    story,
    onClick
}) => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-4 left-4 z-10">
                <img className="rounded-full border-[3px] border-blue-500" width='40px' height='40px' src={user?.avatar ?? images.user} />
            </div>
