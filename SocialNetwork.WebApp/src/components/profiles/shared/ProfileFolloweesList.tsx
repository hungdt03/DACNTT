...
const ProfileFolloweeList: FC<ProfileFolloweeListProps> = ({
    ...
    return <div className="grid grid-cols-2 gap-4">
        {followees.map(followee => <Link to={`/profile/${followee.id}`} key={followee.id} className="flex items-center justify-between p-4 rounded-md border-[1px] border-gray-100">
