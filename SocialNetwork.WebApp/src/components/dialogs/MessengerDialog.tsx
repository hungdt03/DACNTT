    ...
    return <>
        <div className="flex flex-col gap-y-3 w-[330px]">
            ...
            <div className="flex flex-col gap-y-2 p-2 max-h-[70vh] overflow-y-auto custom-scrollbar">
                {chatRooms.map(chatRoom => <div onClick={() => dispatch(add(chatRoom))} key={chatRoom.id} className="flex items-center gap-x-3 py-2 px-3 hover:bg-gray-100 rounded-md cursor-pointer">
