...
const SearchGroupBlock: FC<SearchGroupBlockProps> = ({
    ...
    return <div className="p-4 shadow border-[1px] border-gray-100 rounded-lg bg-white">
        ...
        <div className="flex flex-col gap-y-4">
            ...
            <Link to={`/search/?type=group&q=${searchValue}`} className="w-full py-2 text-sm hover:bg-sky-100 rounded-md bg-sky-50 text-primary font-semibold">Xem tất cả</Link>
        </div>
    </div>
};
